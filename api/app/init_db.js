    ...
    DBModel.Category.sync({force: true}).then(() => {
      ...
      DBModel.Article.sync({force: true}).then(() => {
        let articles = [
          ...
          { name: 'Article 3', summary: 'Summary 3', categoryId: 1 },
          { name: 'Article 4', summary: 'Summary 4', categoryId: 1 },
          { name: 'Article 5', summary: 'Summary 5', categoryId: 1 },
          { name: 'Article 6', summary: 'Summary 6', categoryId: 2 },
